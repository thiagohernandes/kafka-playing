...
import com.br.kafka.buy.producer.sender.BuyEventProductSender;
...
public class BuyProducer {
    ...
    private BasicExceptionHandler basicExceptionHandler;
    ...
    @Autowired
    public BuyProducer(BasicExceptionHandler basicExceptionHandler) {
        this.basicExceptionHandler = basicExceptionHandler;
    }
